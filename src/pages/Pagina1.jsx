...
export function Pagina1() {
  return (
    <Home>
      ...
      <main>
        <section class="info">
          <h2 class="Subtitulo">Sobre o Produto</h2>
          <p class="Descricao">Apresentamos nossa solução inovadora para problemas respiratórios, projetada para transformar a maneira como você cuida da sua saúde. Junte-se a nós nesta jornada de avanço tecnológico em prol de uma melhor qualidade de vida.</p>
        </section>
        <section>
